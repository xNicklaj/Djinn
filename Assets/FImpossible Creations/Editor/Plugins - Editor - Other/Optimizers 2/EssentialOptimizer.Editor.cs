...
namespace FIMSpace.FOptimizing
{
    public partial class Optimizer_BaseEditor : Editor
    {
        ...
        public class EssentialOptimizerEditor : Optimizer_BaseEditor
        {
            ...
            { Optimizer_Base._HandleUnityLODWithReload = !Optimizer_Base._HandleUnityLODWithReload; if (Optimizer_Base._HandleUnityLODWithReload) UnityEngine.Debug.Log("[Optimizers] Now Unity LOD component will be supported"); else UnityEngine.Debug.Log("[Optimizers] Now Unity LOD component will not be detected by Optimizers components"); UnityEditor.Menu.SetChecked(menuItemunityLOD, Optimizer_Base._HandleUnityLODWithReload); }

            [MenuItem(menuItemunityLOD, true, 100000)]
            public static bool ToggleUnityLODHandlingValidate()
            { UnityEditor.Menu.SetChecked(menuItemunityLOD, Optimizer_Base._HandleUnityLODWithReload); return true; }
