...
namespace FIMSpace.FOptimizing
{
    ...
    public sealed class LODI_Renderer : ILODInstance
    {
        ...
        public EShadowsMode UseShadows = EShadowsMode.On;
        ...
        public void SetSameValuesAsComponent(Component component)
        {
            ...
            if (comp != null)
            {
                ...
                UseShadows = EShadowsMode.On;
                if (comp.shadowCastingMode == UnityEngine.Rendering.ShadowCastingMode.Off) UseShadows = EShadowsMode.Off;
        ...
        public void AssignAutoSettingsAsForLODLevel(int lodIndex, int lodCount, Component component)
        {
            ...
            UseShadows = (comp.shadowCastingMode == UnityEngine.Rendering.ShadowCastingMode.Off) ? EShadowsMode.Off : EShadowsMode.On;
            ...
            if (mul < 0.55f) UseShadows = EShadowsMode.Off;

            if (lodIndex == lodCount - 2)
            {
                UseShadows = EShadowsMode.Off;
