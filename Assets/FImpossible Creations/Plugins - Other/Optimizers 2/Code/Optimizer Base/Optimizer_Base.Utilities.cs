...
namespace FIMSpace.FOptimizing
{
    public abstract partial class Optimizer_Base
    {
        ...
        protected Action onLODStateChange = null;

        /// <summary> 
        /// Provided action will be called by the optimizers component when culling state changes.
        /// Then you can check state of the myOptimizer.CurrentLODLevel / .IsCulled / .IsHidden
        /// </summary>
        public void AssignOnLODStateChangeAction(Action onLODStateChange) 
        {
            this.onLODStateChange = onLODStateChange;
        }

        protected void CallOnLODStateChangeAction()
        {
            if (onLODStateChange != null) onLODStateChange.Invoke();
        }
