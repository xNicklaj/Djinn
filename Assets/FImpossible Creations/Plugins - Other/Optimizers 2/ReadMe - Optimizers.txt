...
v2.2.3.1
- Fixed dynamic clock index problem

v2.2.3
- Added menu option to apply same assigned LOD level for unity LOD Group components when clicking on the info box "Using Optimizer instead of..."

v2.2.2.6.3
- Added menu option to remove all added components in 'To Optimize' list when hitting right mouse button on the 'To Optimize List' bookmark.

v2.2.2.6.2
- Now MonoBehaviour LOD settings starts in simplified version
