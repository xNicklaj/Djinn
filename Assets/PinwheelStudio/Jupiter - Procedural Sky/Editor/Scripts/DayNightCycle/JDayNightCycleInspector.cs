...
namespace Pinwheel.Jupiter
{
    ...
    public class JDayNightCycleInspector : Editor
    {
        ...
        private static void InitAllAnimatableProperties()
        {
            ...
            for (int i = 0; i < props.Length; ++i)
            {
                ...
                if (att != null)
                {
                    ...
                    AllProperties.Add(JAnimatedProperty.Create(props[i].Name, animAtt.DisplayName, animAtt.CurveOrGradient, animAtt.Target));
                }
            }
        }
        ...
        private void DrawAmbientGUI()
        {
            string label = "Ambient";
            string id = "ambient";

            JEditorCommon.Foldout(label, false, id, () =>
            {
                DisplayAddedProperties("Ambient");
                if (GUILayout.Button("Add"))
                {
                    DisplayAllPropertiesAsContext("Ambient");
                }
            });
        }
