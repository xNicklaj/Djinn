...
namespace Pinwheel.Jupiter
{
    public static class JMat
    {
        ...
        public static readonly int TIME = Shader.PropertyToID("_JupiterTime");
        ...
        public static readonly int OVERHEAD_CLOUD_FLOW_SPEED = Shader.PropertyToID("_OverheadCloudFlowSpeed");
