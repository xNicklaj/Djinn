// This implementation of a serializable dictionary has been borrowed by the Core RP package.
// However, we didn't want to introduce a dependency to that package only to use one class.
...
{
    [Serializable]
    public sealed class SerializableStringDictionary : SerializedDictionary<string, string> { }
    
    [Serializable]
    public sealed class SerializableGODictionary : SerializedDictionary<string, GameObject> { }
